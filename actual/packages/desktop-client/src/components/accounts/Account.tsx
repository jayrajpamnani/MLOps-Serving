...
import { CustomCategoryTagger } from '../../ml/CustomCategoryTagger';
        ...
        {(allTransactions, allBalances) => (
          ...
          >
            <View style={styles.page}>
              ...
              {accountId && accountId !== 'offbudget' && accountId !== 'onbudget' && accountId !== 'uncategorized' && (
                <View style={{ padding: '4px 12px' }}>
                  <CustomCategoryTagger accountId={accountId} />
                </View>
              )}
